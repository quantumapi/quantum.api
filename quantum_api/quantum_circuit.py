...
# Configuration for surface code parameters
SURFACE_CODE_ANCILLA_COUNT = int(os.getenv('SURFACE_CODE_ANCILLA_COUNT', 7))
...
def apply_surface_code(circuit: QuantumCircuit) -> QuantumCircuit:
    ...
    try:
        ...
        ancilla = QuantumRegister(SURFACE_CODE_ANCILLA_COUNT, name="ancilla")
        ...
        for i in range(SURFACE_CODE_ANCILLA_COUNT):
            circuit.cx(0, circuit.num_qubits - 1 - i)
        # Create classical register for ancilla measurement
        creg = ClassicalRegister(SURFACE_CODE_ANCILLA_COUNT, name="c_ancilla")
